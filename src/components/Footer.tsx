...
/** Only the networks with a URL configured are rendered. */
const socials = [
  {
    label: "LinkedIn",
    href: site.socials.linkedin,
    path: "M6.94 8.5V19H3.6V8.5zM5.27 3.5a1.94 1.94 0 1 1 0 3.88 1.94 1.94 0 0 1 0-3.88M20.4 19h-3.34v-5.5c0-1.4-.5-2.35-1.75-2.35-.95 0-1.52.64-1.77 1.27-.09.22-.11.53-.11.85V19H10.1s.04-9.5 0-10.5h3.33v1.49c.44-.69 1.24-1.67 3.02-1.67 2.2 0 3.85 1.44 3.85 4.54z",
  },
  {
    label: "X",
    href: site.socials.x,
    path: "M17.2 3h3.3l-7.2 8.2L21.7 21h-6.6l-4.3-5.6L5.7 21H2.4l7.7-8.8L2.6 3h6.8l3.9 5.2zm-1.2 16h1.8L8.1 4.9H6.2z",
  },
  {
    label: "GitHub",
